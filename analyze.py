...
process.source = cms.Source("PoolSource",
    ...
    eventsToProcess = cms.untracked.VEventRange('324077:564848705-324077:max'),
)
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('analyze.root'),
...
process.TFileService.fileName=cms.string('elements.root')
